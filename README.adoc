...
Note: See link:src/main/java/com/ekart/e2e/test/service/apis/metrics/ElbStatisticsCollector.java[] for details how ELB health check statistics are calculated
